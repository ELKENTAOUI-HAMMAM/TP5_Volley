...
public class ListEtudiantActivity extends AppCompatActivity implements EtudiantAdapter.OnItemClickListener {
    ...
    // Update these URLs
    private String fetchUrl = "http://192.168.1.121/projet/ws/loadEtudiant.php";
    private String updateUrl = "http://192.168.1.121/projet/ws/updateEtudiant.php";
    private String deleteUrl = "http://192.168.1.121/projet/ws/deleteEtudiant.php";
